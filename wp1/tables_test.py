...
class TablesDbTest(BaseWpOneDbTest):
    ...
    def test_get_project_categories(self):
        expected = {
            "imp_labels": {
                b"High-Class": "{{High-Class|category=Category:High-importance_Catholicism_articles}}",
                b"Low-Class": "{{Low-Class|category=Category:Low-importance_Catholicism_articles}}",
                b"Mid-Class": "{{Mid-Class|category=Category:Mid-importance_Catholicism_articles}}",
            ...
            "qual_labels": {
                b"A-Class": "{{A-Class|category=Category:A-Class_Catholicism_articles}}",
                b"Assessed-Class": "{{Assessed-Class}}",
                b"B-Class": "{{B-Class|category=Category:B-Class_Catholicism_articles}}",
                b"Book-Class": "{{Book-Class|category=Category:Book-Class_Catholicism_articles}}",
                b"C-Class": "{{C-Class|category=Category:C-Class_Catholicism_articles}}",
                b"Category-Class": "{{Category-Class|category=Category:Category-Class_Catholicism_articles}}",
                b"Disambig-Class": "{{Disambig-Class|category=Category:Disambig-Class_Catholicism_articles}}",
                b"FA-Class": "{{FA-Class|category=Category:FA-Class_Catholicism_articles}}",
                b"FL-Class": "{{FL-Class|category=Category:FL-Class_Catholicism_articles}}",
                b"FM-Class": "{{FM-Class|category=Category:FM-Class_Catholicism_articles}}",
                b"File-Class": "{{File-Class|category=Category:File-Class_Catholicism_articles}}",
                b"GA-Class": "{{GA-Class|category=Category:GA-Class_Catholicism_articles}}",
                b"Image-Class": "{{Image-Class|category=Category:Category:Image-Class Catholicism articles}}",
                b"List-Class": "{{List-Class|category=Category:List-Class_Catholicism_articles}}",
                b"NA-Class": "{{NA-Class|category=Category:NA-Class_Catholicism_articles}}",
                b"NotA-Class": ' style="text-align: center;" | ' "'''Other'''",
                b"Portal-Class": "{{Portal-Class|category=Category:Portal-Class_Catholicism_articles}}",
                b"Project-Class": "{{Project-Class|category=Category:Project-Class_Catholicism_articles}}",
                b"Redirect-Class": "{{Redirect-Class|category=Category:Redirect-Class_Catholicism_articles}}",
                b"Start-Class": "{{Start-Class|category=Category:Start-Class_Catholicism_articles}}",
                b"Stub-Class": "{{Stub-Class|category=Category:Stub-Class_Catholicism_articles}}",
                b"Template-Class": "{{Template-Class|category=Category:Template-Class_Catholicism_articles}}",
    ...
    def test_data_for_stats(self):
        ...
        expected_data = {
            b"C-Class": {b"Low-Class": 2, b"Unknown-Class": 1},
            b"Start-Class": {
                b"High-Class": 3,
                b"Low-Class": 6,
                b"Mid-Class": 1,
