...
def update_page_moved(
    wp10db, project, old_ns, old_title, new_ns, new_title, move_timestamp_dt
):
    logger.debug(
        "Updating moves table for %s -> %s",
        old_title.decode("utf-8"),
