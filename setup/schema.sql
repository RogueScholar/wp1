CREATE TABLE `automatedselection` (
    ...
    PRIMARY KEY (`as_article`)) ENGINE = InnoDB DEFAULT CHARSET = latin1;
...
CREATE TABLE `categories` (
    ...
    PRIMARY KEY (`c_project`, `c_type`, `c_rating`)) ENGINE = InnoDB DEFAULT CHARSET = latin1;
...
CREATE TABLE `global_articles` (
    ...
    KEY `score` (`a_score`)) ENGINE = InnoDB DEFAULT CHARSET = latin1;
...
CREATE TABLE `global_rankings` (
    ...
    KEY `gr_type` (`gr_type`,
        `gr_ranking`)) ENGINE = InnoDB DEFAULT CHARSET = latin1;
...
CREATE TABLE `logging` (
    ...
    KEY `l_article` (`l_article`,
        `l_namespace`)) ENGINE = InnoDB DEFAULT CHARSET = latin1;
...
CREATE TABLE `moves` (
    ...
    KEY `m_new_namespace` (`m_new_namespace`,
        `m_new_article`)) ENGINE = InnoDB DEFAULT CHARSET = latin1;
...
CREATE TABLE `namespacename` (
    ...
    KEY `dbname` (`dbname`,
        `ns_id`,
        `ns_type`)) ENGINE = InnoDB DEFAULT CHARSET = latin1;
...
CREATE TABLE `projects` (
    ...
    PRIMARY KEY (`p_project`)) ENGINE = InnoDB DEFAULT CHARSET = latin1;
...
CREATE TABLE `ratings` (
    ...
    KEY `nstitle` (`r_namespace`,
        `r_article` (50))) ENGINE = InnoDB DEFAULT CHARSET = latin1;
...
CREATE TABLE `selection_data` (
    ...
    PRIMARY KEY (`sd_article`)) ENGINE = InnoDB DEFAULT CHARSET = latin1;
...
CREATE TABLE `workingselection` (
    ...
    PRIMARY KEY (`ws_article`)) ENGINE = InnoDB DEFAULT CHARSET = latin1;
...
CREATE TABLE `manualselectionlog` (
    ...
    KEY `msl_user` (`msl_user`)) ENGINE = InnoDB DEFAULT CHARSET = latin1;
...
CREATE TABLE `passwd` (
    ...
    PRIMARY KEY (`pw_user`)) ENGINE = InnoDB DEFAULT CHARSET = utf8 COLLATE = utf8_bin;
...
CREATE TABLE `releases` (
    ...
    KEY `rel_0p5_category` (`rel_0p5_category`)) ENGINE = InnoDB DEFAULT CHARSET = latin1;
